            ...
            children: [
              ...
              Expanded(
                child: Container(
                  ...
                  child: Padding( // Use Padding to create space above the ListView
                      ...
                      builder: (context, snapshot) {
                        ...
                        return ListView.builder(
                          ...
                          itemBuilder: (context, index) {
                            ...
                            return Container(
                              margin: const EdgeInsets.symmetric(vertical: 15, horizontal: 16), // Adjust margin as needed
                              decoration: BoxDecoration(
                              ...
                              child: ListTile(
                                title: Text(
                                  'Name: $fullName', style: TextStyle(fontSize: 16, fontWeight: FontWeight.bold) // Dark text color
                                ),
                                onTap: () {
